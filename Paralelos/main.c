...
void ordenarAlumnosByPromedio(int[], int[], char[], int[],int[],int[], float[], int);
int main()
{
    ...
    do
    {
        ...
        switch(opcion)
        {
            ...
            case 5:
                ordenarAlumnosByPromedio(legajo, edad, sexo, nota1,nota2,nota3,promedio,T);
                    mostrarAlumnos(legajo, edad, sexo, nota1,nota2,nota3,promedio,T);
                break;
...
void ordenarAlumnosByPromedio(int legajo[], int edad[], char sexo[], int nota1[],int nota2[],int nota3[], float promedio[], int cant)
{
    int i;
    int j;
    int auxInt;
